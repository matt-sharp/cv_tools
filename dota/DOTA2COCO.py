...
# wordname_15 = ['plane',  'ground-track-field', 'small-vehicle', 'large-vehicle', 'ship', 'tennis-court',
#                'basketball-court', 'storage-tank',  'soccer-ball-field', 'roundabout',]

# wordname_15 = ['storage-tank','bridge','plane', 'ship','ground-track-field', 'roundabout','small-vehicle', 'large-vehicle']  

wordname =   ['storage-tank','bridge','ground-track-field','roundabout']             
...
if __name__ == '__main__':
    ...
    DOTA2COCOTrain(r'/home/zoucg/cv_project/data/others/train',
                   r'/home/zoucg/cv_project/data/others/train/others_1024.json',
                   wordname)
    DOTA2COCOTrain(r'/home/zoucg/cv_project/data/others/val',
                   r'/home/zoucg/cv_project/data/others/val/others_1024.json',
                   wordname)
